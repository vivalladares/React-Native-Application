...
export default class Energia extends React.Component{
    ...
    componentDidMount() {
        ...
        .then((res) => {
            if(res !== null) {
                console.log(res);
                this.setState({ carregando: false, todos_os_itens: res, copy_itens: res, copy_itens_1: res.filter(i => i.categoria == 1 && i.areas==2 ) });
                this.setState({ carregando: false, todos_os_itens: res, copy_itens: res, copy_itens_2: res.filter(i => i.categoria == 2  && i.areas==2) });
                this.setState({ carregando: false, todos_os_itens: res, copy_itens: res, copy_itens_3: res.filter(i => i.categoria == 3  && i.areas==2 ) });
                this.setState({ carregando: false, todos_os_itens: res, copy_itens: res, copy_itens_4: res.filter(i => i.categoria == 4  && i.areas==2 ) });
            }
        })
    }
